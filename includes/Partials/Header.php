...
/**
 * Header partial of Skin MoeSkin
...
final class Header extends Partial {
	...
	*/
	public function buildSearchProps(): array {
		$skin = $this->skin;
		$toggleMsg = $skin->msg( 'moeskin-search-toggle' )->text();

		return [
			// TODO: This should be called in skin.json
			'msg-moeskin-search-toggle' => $toggleMsg,
			'msg-moeskin-search-toggle-shortcut' => $toggleMsg . ' [/]',
